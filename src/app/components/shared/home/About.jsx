          ...
          <div className="flex-1">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-black text-gray-900 dark:text-white leading-tight mb-8">
                ...
                <span className="text-blue-600">Modern Style</span>
              </h2>

              <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed mb-8">
                At IconFashion, we don&apos;t just sell clothes; we curate
                identities. Our journey began with a simple mission: to make
                high-end fashion accessible without compromising on
                sustainability or comfort.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
                {[
                  ...
                  },
                  {
                    ...
                    text: "Exclusive Limited Designs",
                  },
                  {
              ...
              <MotionLink
                ...
                whileTap={{ scale: 0.95 }}
                className="mt-12 inline-block bg-blue-600 hover:bg-blue-700 text-white px-10 py-4 rounded-2xl font-bold shadow-2xl shadow-blue-500/30 transition-all"
              >
                Learn More About Us
              </MotionLink>
            </motion.div>
